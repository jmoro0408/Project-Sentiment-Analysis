...
TokenizerType =  transformers.models.distilbert.tokenization_distilbert_fast.DistilBertTokenizerFast
ModelType =  transformers.models.distilbert.modeling_distilbert.DistilBertForSequenceClassification
...
def main():
    ...
    print(f"Article title: {test_title} is {results[0]:.4f} negative and {results[1]:.4f} positive")
